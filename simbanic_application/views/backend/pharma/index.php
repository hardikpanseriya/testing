...
<script type="text/javascript">
    ...
    var grid = simbanic_grid_list.bootgrid({
        ...
        formatters: {
            ...
            {
                return "<a href=\"" + base_url + "pharma/edit/" + row.id + "\" class=\"btn btn-sm purple\"><i class=\"fa fa-edit\"></i> Edit</a> " + 
                    "<a class=\"btn btn-sm red\" onclick=\"return simbanicRemove('pharma', "+ row.id +")\"><i class=\"fa fa-trash-o\"></i> Delete</a>";
            },
        }
