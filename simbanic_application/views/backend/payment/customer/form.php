<?= form_open("payment/customer/save"); ?>
	<?php
	if(isset($record))
	{
	...
	{
		echo form_hidden('retailer_id', $retailer_id);
	}
	$url = 'http://' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
	if (strpos($url, 'payment/customer/create') !== false)
	{
		echo form_hidden('created_at', $this->ion_auth->user()->row()->user_type);
		echo form_hidden('created_by', $this->ion_auth->get_user_id());
	}
