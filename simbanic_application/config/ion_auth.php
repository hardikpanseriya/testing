 ...
 */
$config['site_title']                 = "WalartPharma";       // Site Title, example.com
$config['admin_email']                = "admin@example.com"; // Admin Email, admin@example.com
$config['default_group']              = 'customer';        // Default group, use name
$config['admin_group']                = 'admin';             // Default administrators group, use name
$config['customer_group']                = 'customer';             // Default customer group, use name
$config['depot_group']                = 'depot';             // Default depot group, use name
$config['pharma_group']                = 'pharma';             // Default pharma group, use name
$config['identity']                   = 'customer_id';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
